                ...
                <Grid item sm={7} md={4} xs={12} className={classes.rightDiv}>
                    ...
                    <div className={classes.paperPictureRight}>
                        <div className={classes.paperFilterRight}>
                            <Typography variant='h3' className={classes.logo}>Work<IconButton className={classes.Iconbg}><BuildIcon className={classes.largeIcon} /><BuildIcon className={classes.largeIcon} style={{ marginLeft: '-72', transform: 'rotate(90deg' }} /></IconButton>Shop</Typography>
                            <hr />
                            <div className={classes.headText} >
                                ...
                                <div className={classes.copyrights}><p style={{ color: 'red' }}>© WorkShop 2021. ALL RIGHTS RESERVED.</p></div>
                            </div>
                        </div>
                    </div>
                </Grid>
